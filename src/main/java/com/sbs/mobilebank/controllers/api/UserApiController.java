package com.sbs.mobilebank.controllers.api;

import com.sbs.mobilebank.entities.HttpResponse;
...
import com.sbs.mobilebank.shared.utils.JWTTokenProvider;
import com.sbs.mobilebank.ui.models.request.UserDetailsRequestModel;
import com.sbs.mobilebank.ui.models.response.UserResponse;
...
import static com.sbs.mobilebank.security.constant.SecurityConstant.JWT_TOKEN_HEADER;
...
public class UserApiController extends ExceptionHandling {
    ...
    @Autowired
    public UserApiController(AuthenticationManager authenticationManager, UserService userService, JWTTokenProvider jwtTokenProvider) {
    ...
    public String home() throws EmailExistException {
        throw new EmailExistException("This email already has been taken");
    }
    ...
    public ResponseEntity<Users> register(@RequestBody Users user) throws UserNotFoundException, UsernameExistException, EmailExistException, MessagingException, javax.mail.MessagingException {
    ...
    public byte[] getProfileImage(@PathVariable("username") String username, @PathVariable("fileName") String fileName) throws IOException {
        ...
        //path is (user.home) + /suportportal/user/djaitai/djaitai.jpg
    }
    ...
    public UserResponse addNewUser(UserDetailsRequestModel userDetailsRequestModel)
                                    throws Exception{
        ...
        System.out.println("**** User created ******** : " +createdUser.getUserEmail());
        return returnValue;
    }

    //get one user
    /*@GetMapping(value = "/find/userCode/{userCode}")
    public UserResponse getUser(@PathVariable String userCode) {
        UserResponse returnValue = new UserResponse();
        UserDTO userDto = userService.getUserByUserId(userCode);
        ModelMapper modelMapper = new ModelMapper();
    ...
    @PutMapping(value = "/update")
            public UserResponse updateUser(@PathVariable String userCode, @RequestBody UserDetailsRequestModel userDetails) {
        UserResponse returnValue = new UserResponse();
        UserDTO userDTO = new UserDTO();
        userDTO = new ModelMapper().map(userDetails, UserDTO.class);
        UserDTO updateUser = userService.updateUser(userCode, userDTO);
